...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///D:/code/portofolio-akiraa/portfoliov1/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///D:/code/portofolio-akiraa/portfoliov1/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/unhead/dist/server.mjs';
import { isVNode, isRef, toValue } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/vue/index.mjs';
import { DeprecationsPlugin } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/unhead/dist/plugins.mjs';
import { klona } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/scule/dist/index.mjs';
import { defineDiagnostics, createConsoleReporter } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/nostics/dist/formatters/ansi.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/vue/server-renderer/index.mjs';
import { stringify, uneval } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/devalue/index.js';
import { createHooks } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/errx/dist/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://D:/code/portofolio-akiraa/portfoliov1/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/code/portofolio-akiraa/portfoliov1/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/code/portofolio-akiraa/portfoliov1","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/code/portofolio-akiraa/portfoliov1/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/code/portofolio-akiraa/portfoliov1/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/code/portofolio-akiraa/portfoliov1/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/code/portofolio-akiraa/portfoliov1/.data/kv"}));
...
const _Nlagte8LEg4FfHvtjJ8Fs0qZE_ReF0k1A9bu1DaO15A = (function(nitro) {
...
const rootDir = "D:/code/portofolio-akiraa/portfoliov1";
...
const plugins = [
  _Nlagte8LEg4FfHvtjJ8Fs0qZE_ReF0k1A9bu1DaO15A,
...
const _wJUjOi = eventHandler((event) => {
...
const _lazy_2oQl97 = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _wJUjOi, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_2oQl97, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2oQl97, lazy: true, middleware: false, method: undefined }
];
